<form id="frmActualizarUsuario" method="POST" onsubmmit="return actualizarUsuario()">
    <!-- Modal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="usuariou" name="usuariou" autocomplete="username">
                </div>
        </div>
        <div class="row">
                <div class="col-sm-12">
